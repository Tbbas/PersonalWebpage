...
class WishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wish" do
    assert_difference('Wish.count') do
      post wishes_url, params: { wish: { description: @wish.description, image: @wish.image, name: @wish.name, product_id: @wish.product_id } }
    end
  ...
  test "should update wish" do
    patch wish_url(@wish), params: { wish: { description: @wish.description, image: @wish.image, name: @wish.name, product_id: @wish.product_id } }
